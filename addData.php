...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Barang</a>
          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              <label for="nis" class="form-label">Nomor faktur</label>
                              <input type="number" class="form-control w-50" id="nomor faktur" placeholder="Masukkan No faktur" min="1"
                                   name="no faktur" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                              <label for="tmpt_Beli" class="form-label">Tempat Lahir</label>
                              <input type="text" class="form-control w-50" id="tmpt_beli"
                                   placeholder="Masukkan Tempat Beli" name="tmpt_beli" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label for="tgl_Beli" class="form-label">Tanggal Lahir</label>
                              <input type="date" class="form-control w-50" id="tgl_Beli" name="tgl_Beli"
                                   max="01-01-2050" required>
                         </div>
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                              <label for="No barang" class="form-label">Nomor barang</label>
                              <select class="form-select w-50" id="No barang" name="Nomor barang">
                         ...
                         <div class="mb-3">
                              ...
                              <input type="harga barang" class="form-control w-50" id="harga barang" placeholder="Masukkan harga barang"
                         ...
                         <div class="mb-3">
                              ...
                              <textarea class="form-control w-50" id="jumlah barang" rows="5" name="jumlah barang"
                                   placeholder="Masukkan jumlah barang" autocomplete="off" required></textarea>
                         </div>
                         <hr>
